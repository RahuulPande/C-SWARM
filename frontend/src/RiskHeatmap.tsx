    ...
    function animate() {
      ...
      cubes.forEach((cube, i) => {
        ...
        if (cube.userData.risk > 0.7 && frame % 60 < 30) {
          (cube.material as THREE.MeshPhongMaterial).emissive.set('#ff00ff');
        } else if (cube.userData.risk > 0.4) {
          (cube.material as THREE.MeshPhongMaterial).emissive.set('#ffff00');
        } else {
          (cube.material as THREE.MeshPhongMaterial).emissive.set('#00ff00');
        }
      });
